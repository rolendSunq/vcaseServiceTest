		...
		<div class="content_wrap">
			<div id="content">
                ...
                <div class="title_tab_con">
                    ...
                    <!-- 탭메뉴 -->
                    <ul class="admin_tab">
                        <li><a id="goUploader">업로더 설정</a></li>
                        <li class="on"><a id="goDoc">Document</a></li>
                        <li><a id="goLog">Log</a></li>
                        <li></li>
                        <li></li>
                        <li></li>
                        <li></li>
                ...
                <div class="admin_contents">
                    ...
                    <!-- Delete_Category 팝업 -->
                    <div class="category_popup delete">
                        <div class="category_title_con">
                            <p>Category Delete</p>
                            <p class="close"><a><img src="./resources/images/admin/close_btn.png" alt="close"/></a></p>
                        </div>
                    ...
                    <div class="left_menu">
                        ...
                        <ul class="left_menu_list">
                            <li class="on">
                                ...
                                <span class="num"><a>300</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Company</a></span>
                                <span class="num"><a>20</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Company (RAW)</a></span>
                                <span class="num"><a>21</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Culture</a></span>
                                <span class="num"><a>23</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Culture (RAW)</a></span>
                                <span class="num"><a>87</a></span>
                            </li>
                            <li>
                                <span class="text"><a>PR (TV)</a></span>
                                <span class="num"><a>55</a></span>
                            </li>
                            <li>
                                <span class="text"><a>PR (TV) (RAW)</a></span>
                                <span class="num"><a>5</a></span>
                            </li>
                            <li>
                                <span class="text"><a>CSR</a></span>
                                <span class="num"><a>2</a></span>
                            </li>
                            <li>
                                <span class="text"><a>CSR (RAW)</a></span>
                                <span class="num"><a>40</a></span>
                            </li>
                            <li>
                                <span class="text"><a>HR</a></span>
                                <span class="num"><a>12</a></span>
                            </li>
                            <li>
                                <span class="text"><a>HR (RAW)</a></span>
                                <span class="num"><a>54</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Others</a></span>
                                <span class="num"><a>54</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Others (RAW)</a></span>
                                <span class="num"><a>78</a></span>
                            </li>
                            <li>
                                <span class="text"><a>TV AD</a></span>
                                <span class="num"><a>5</a></span>
                            </li>
                            <li>
                                <span class="text"><a>TV AD (RAW)</a></span>
                                <span class="num"><a>6</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Campaign</a></span>
                                <span class="num"><a>7</a></span>
                            </li>
                            <li>
                            ...
                            <li>
                                <span class="text"><a>Others (RAW)</a></span>
                                <span class="num"><a>9</a></span>
                            </li>
                            <li>
                                <span class="text"><a>PCR</a></span>
                                <span class="num"><a>55</a></span>
                            </li>
                            <li>
                                <span class="text"><a>PCR (RAW)</a></span>
                                <span class="num"><a>4</a></span>
                            </li>
                            <li>
                                <span class="text"><a>LTR</a></span>
                                <span class="num"><a>22</a></span>
                            </li>
                            <li>
                                <span class="text"><a>LTR (RAW)</a></span>
                                <span class="num"><a>7</a></span>
                            </li>
                            <li>
                                <span class="text"><a>TBR</a></span>
                                <span class="num"><a>2</a></span>
                            </li>
                            <li>
                                <span class="text"><a>TBR (RAW)</a></span>
                                <span class="num"><a>3</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Concept Tire</a></span>
                                <span class="num"><a>0</a></span>
                            </li>
                            <li>
                                <span class="text"><a>Concept Tire (RAW)</a></span>
                                <span class="num"><a>0</a></span>
                            </li>
                            <li>
                    ...
                    <!-- 리스트 -->
                        <div class="list_con">
                            <ul>
                                <li>
                                    <div class="list_check"><input type="checkbox" name="" value=""/></div>
                                    <div class="list_menu">
                                        <div class="list_img">
                                            <a><img src="./resources/images/admin/list_thumb_img.png" alt="썸네일이미지"/></a>
                                        </div>
                                        <div class="title_hit_con">
                                            <p class="list_title">RA33_Dynapro HP2_Motion Graphic(ENG)</p>
                                            <p class="list_hit">2,384,880 views</p>
                                        </div>
                                        <div class="list_date">
                                    ...
                                    <div class="view_con">
                                        ...
                                        <div class="save_btn_con">
                                            <a><img src="./resources/images/admin/view_save_btn.png" alt="save"/></a>
                                        </div>
                                        <!-- //save btn -->
                                    </div>
                                    <!-- //view화면 -->
                    ...
                    <div class="paging_con">
                        <div class="left_btn_con">
                            ...
                            <div class="add_delete">
                                <span><a><img src="./resources/images/admin/add_btn.png" alt="파일추가"/></a></span>
                                <span><a><img src="./resources/images/admin/delete_btn.png" alt="파일삭제"/></a></span>
                            </div>
                        </div>
