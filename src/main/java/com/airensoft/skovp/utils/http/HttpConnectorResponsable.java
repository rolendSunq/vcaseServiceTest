...
public class HttpConnectorResponsable implements HttpConnectorResponse
{
	...
	/**
	 * <pre>
	 * http?µÏã† ??response Í≤∞Í≥º ObjectÎ•?Î∞òÌôò?úÎã§
	 * </pre>
	 * 
	 * @return
	 */
	...
	/**
	 * <pre>
	 * HTTP ?îÏ≤≠ Í≤∞Í≥º ?ÅÌÉú ÏΩîÎìúÎ•?Î∞òÌôò?úÎã§
	 * </pre>
	 * @return HTTP ?îÏ≤≠ Í≤∞Í≥º ?ÅÌÉú ÏΩîÎìú
	 */
	@Override
